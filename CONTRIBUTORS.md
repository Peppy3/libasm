...
No direct copying or use of AI to modify the source code. If you use AI, make
sure to at least understand what matrix multiplications is providing you.
...
- We use 4 spaces as indentation and keep the local labels on the same line as
